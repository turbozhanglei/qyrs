 ...
 * @author xuyongliang
 * @version V1.0
 * @className AddCorrelationRequest
 * @description 浏览分享打电话记录
 * @date 2020/2/15
 */
...
@AllArgsConstructor
@NoArgsConstructor
public class AddCorrelationRequest implements Serializable{


    private static final long serialVersionUID = 1853192259346037179L;
