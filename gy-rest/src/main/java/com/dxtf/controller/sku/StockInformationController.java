...
import com.dxtf.util.CommonUtil;
import com.dxtf.util.DateUtil;
import com.dxtf.util.MailHelper;
...
public class StockInformationController extends BizAction {
    ...
    private void sendWarnEmail(Dto dto) throws Exception {
        ...
        String dxtfSendEmailGroup = CommonUtil.getSysConfig().getAsString("DXTF_SEND_EMAIL_GROUP");
        if (StringUtils.isNotEmpty(dxtfSendEmailGroup)) {
            toEmailAddress = toEmailAddress + "," + dxtfSendEmailGroup;
        }
